  ...
  const levelOptions = useMemo(
    () =>
      choseLevel.map((choseLevel, index) => (
        <StyledOption key={index} value={choseLevel}>
          {choseLevel}
        </StyledOption>
      )),
    [choseLevel]
      ...
      {get ? (
        <ProfileWrapper>
          <TopSection>
            <LeftWrapper>
              <ProfileImage>
                <Image src="/assets/test.jpg" alt="Profile" />
              </ProfileImage>
                  ...
                  <LeftColumn>
                    ...
                    <BubbleWrap>
                      {get.languages?.length ? (
                        get.languages.map((language, index) => (
                          <Bubble key={index}>{language}</Bubble>
                        ))
                      ) : (
                    ...
                    <BubbleWrap>
                      {get.skills?.length ? (
                        get.skills.map((skill, index) => (
                          <Bubble key={index}>{skill}</Bubble>
                        ))
                      ) : (
                        <Bubble>{Default}</Bubble>
                      )}
