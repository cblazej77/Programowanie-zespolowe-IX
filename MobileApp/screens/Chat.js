...
import { Colors, ChatLabel, ChatImage, ChatText, ChatIconButton, ChatMessages } from './../components/styles';
    ...
    <View style={{ height: '100%' }}>
      <ChatLabel>
        <ChatIconButton
          ...
          onPress={() => alert('Powrót do wiadomości')}
          activeOpacity={0.5}
        >
        ...
        <View style={{ flex: 3 }}>
          <ChatText numberOfLines={1}>Piotr Nowak</ChatText>
          <ChatText style={{ fontSize: 16 }}>605 263 113</ChatText>
        </View>
