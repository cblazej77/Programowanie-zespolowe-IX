...
const CompanyProfile = ({ route, navigation }) => {
  ...
  return (
    <View style={{ backgroundColor: primary, justifyContent: 'center' }}>
              ...
              <View style={styles.modalView}>
                ...
                <View style={styles.ModalCommisionDetails}>
                  ...
                  <View style={styles.ModalDetail}>
                    ...
                    <RegularText style={{ color: '#6e6968', width: '30%' }}>{modalCommision.level}</RegularText>
                  </View>
                  <View style={styles.ModalDetail}>
                    <RegularText style={{ width: '60%' }}>Lokalizacja:</RegularText>
                    <RegularText style={{ color: '#6e6968', width: '30%' }}>{modalCommision.location}</RegularText>
                  </View>
                </View>
                <Line style={{ width: '90%', height: 1 }} />
