...
const { primary, darkLight, white, black } = Colors;
      ...
      {showArtistPage ? (
        <SafeAreaView style={{ flex: 1, backgroundColor: primary }}>
          ...
          >
            <TouchableOpacity onPress={() => {
              ...
              <Ionicos name="close-outline" color={primary} size={39} style={{marginRight: 15, marginTop: 5}} />
            </TouchableOpacity>
            ...
            >
              <FontAwesome
                ...
                color={primary}
                size={25}
                style={{ marginLeft: 33, marginRight: 5, marginTop: 5 }}
              />
            </TouchableOpacity>
          </ChatLabel>
          <HomeLabel>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: primary }}>
          ...
          >
            ...
            >
              <FontAwesome name={'chevron-left'} color={primary} size={25} style={{ marginLeft: 5, marginRight: 60, marginTop: 5 }} />
            </TouchableOpacity>
